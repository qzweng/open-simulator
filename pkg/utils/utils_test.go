...
func TestGetResourceSimilarity(t *testing.T) {
	...
	nodeRes := simontype.NodeResource{NodeName: "Node11", MilliCpu: 1000, MilliGpuLeftList: []int64{200, 600, 350, 0}, GpuNumber: 4, GpuType: "1080"}
	...
	nodeRes = simontype.NodeResource{NodeName: "Node12", MilliCpu: 1000, MilliGpuLeftList: []int64{1000, 150, 0, 0}, GpuNumber: 4, GpuType: "1080"}
	assert.InDelta(t, GetResourceSimilarity(nodeRes, podRes), 0.99757510083, 1e-3) //(1000*500+1150*500)/(sqrt((1000^2+1150^2))*sqrt((500^2+500^2)))
	nodeRes = simontype.NodeResource{NodeName: "Node13", MilliCpu: 500, MilliGpuLeftList: []int64{500, 75, 0, 0}, GpuNumber: 4, GpuType: "1080"}
	assert.InDelta(t, GetResourceSimilarity(nodeRes, podRes), 0.99757510083, 1e-3) //(1000*500+1150*500)/(sqrt((1000^2+1150^2))*sqrt((500^2+500^2)))
...
func TestCalculateVectorDotProduct(t *testing.T) {
	...
	nodeRes = simontype.NodeResource{NodeName: "P4", MilliCpu: 0, MilliGpuLeftList: []int64{1000, 1000}, GpuNumber: 2, GpuType: "P4"}
	...
	nodeRes = simontype.NodeResource{NodeName: "V100", MilliCpu: 8000, MilliGpuLeftList: []int64{1000}, GpuNumber: 1, GpuType: "V100M16"}
...
func TestCalculateL2NormDiff(t *testing.T) {
	...
	nodeCap := []float64{2000, 4000}
	nodeRes := simontype.NodeResource{NodeName: "1080", MilliCpu: 1000, MilliGpuLeftList: []int64{200, 600, 350, 0}, GpuNumber: 4, GpuType: "1080"}
	nodeVec := NormalizeVector(nodeRes.ToResourceVec(), nodeCap) // (0.5, 0.2875)
